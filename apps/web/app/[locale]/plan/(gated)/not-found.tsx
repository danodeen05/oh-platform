...
export default async function PlanSectionNotFound() {
  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-4 pb-24 pt-8 md:px-8 md:pb-16 md:pt-14">
      <p className="m-0 mb-3 font-display text-[0.95rem] tabular-nums tracking-[0.2em] text-oh-ember">404</p>
      ...
      <a href={`/${locale}/plan`} className="mt-8 inline-block rounded-md bg-oh-ember px-4 py-2 text-[0.9rem] font-semibold text-oh-cream hover:bg-oh-clay">
        {t("backToSummary")}
      </a>
    </section>
  );
