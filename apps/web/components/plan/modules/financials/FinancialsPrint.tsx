...
export async function FinancialsPrint({ locale }: { locale: string }) {
  ...
  const th = "py-1.5 text-right font-normal text-oh-ash";
  ...
  return (
    <div className="mt-6 flex flex-col gap-8 text-[0.85rem]">
      ...
      <table className="w-full border-collapse">
        ...
        <thead><tr className="border-b border-oh-charcoal/30"><th className="py-1.5 text-left font-normal text-oh-ash">{t("capex.line")}</th><th className={th}>{t("capex.flagship")}</th><th className={th}>{t("capex.subsequent")}</th></tr></thead>
      ...
      <table className="w-full border-collapse">
        ...
        <thead><tr className="border-b border-oh-charcoal/30"><th className="py-1.5 text-left font-normal text-oh-ash">{t("platform.line")}</th>{platform.years.map((y) => (<th key={y.year} className={th}>{t("yearShort", { n: y.year })}</th>))}</tr></thead>
